...
int main(int argc, const char *argv[])
{
	...
	kr = do_host_statistics (host, HOST_LOAD_INFO, (host_info_t)&load_info, &count);
	...
	kr = do_host_statistics (host, HOST_CPU_LOAD_INFO, (host_info_t)&cpu_load_info, &count);
    ...
    printf("    page free               = %u\n", vm_stat.free_count);
    printf("    page active             = %u\n", vm_stat.active_count);
    printf("    page inactive           = %u\n", vm_stat.inactive_count);
    printf("    page wired down         = %u\n", vm_stat.wire_count);
    ...
    printf("    object cache hits       = %u (hist rate %2.2f %%)\n", vm_stat.hits,
